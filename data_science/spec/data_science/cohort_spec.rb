...
module DataScience
  describe Cohort do
    ...
    let(:non_conversion_data) { [{ "date" => "2014-03-20", "cohort" => "A", "result" => 0 }] }
      ...
      it 'is instantiated with a 0 conversions' do # Happy Path
        expect(cohort.conversions).to be_zero
      end

      it 'is instantiated with a 0 non-conversions' do # Happy Path
        expect(cohort.non_conversions).to be_zero
      end

      it 'adds parsed split test data to the cohort' do # Happy Path
    ...
    context 'adding website visit data to a cohort' do # Happy Path
      let(:conversions) { 50 }
      ...
      context 'when using 95% confidence' do # Happy Path
        ...
        describe '#error_bars_helper' do # Happy Path
        ...
        describe '#conversion_rate_helper' do # Happy Path
